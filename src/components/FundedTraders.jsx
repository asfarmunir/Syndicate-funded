...
const HowItWorks = () => {
  return (
    <div className=" oyo2  w-full mb-16 py-12 flex flex-col items-center gap-4 relative pb-48">
      <motion.h4
      ...
      <div className=" max-w-3xl  box2 shadow inner-shadow-white-upper 2xl:max-w-4xl border border-b-0  h-72 2xl:h-96 mt-16 flex rounded-[6rem] items-center justify-center relative w-full">
        <img
          src={badge}
          alt="badge"
